...
public class EncodeDecodeTests extends  ESRTest {
    ...
    public void encodeAndDecodeSignedRequest() throws ESRException {
        ...
        signingRequest.sign(new MockSignatureProviderESR());
        ...
        assertEquals("Should get the signature from the provider", MockSignatureProviderESR.MOCK_SIGNATURE, signature.getSignature());
