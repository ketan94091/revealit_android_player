...
public class AccountFragmentContainer extends Fragment implements View.OnClickListener {
    ...
    private LinearLayout linearProfile,linearPrivacyPolicy;


    public AccountFragmentContainer(HomeScreenTabLayout homeScreenTabLayout) {
    ...
    private void setIds() {
        ...
        linearPrivacyPolicy =(LinearLayout)mView.findViewById(R.id.linearPrivacyPolicy);
        linearProfile =(LinearLayout)mView.findViewById(R.id.linearProfile);
    ...
    public void onClick(View mView) {
        ...
        switch (mView.getId()){
            ...
            case R.id.linearPrivacyPolicy:
                ...
                loadFragments(new PrivacyFragment(mHomeScreenTabLayout));
