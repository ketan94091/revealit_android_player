...
public class ListenFragment extends Fragment implements View.OnClickListener, RemoveListenHistory{
    ...
    public static RevealItHistoryListAdapter mRevealItHistoryListAdapter;
    ...
    private void setIds() {
        ...
        mRevealItHistoryListAdapter = null;
   ...
   if(isTimeStampDeleted){
    ...
    public static void updateRevealitHistoryList(boolean isCheckBoxSelected, boolean shouldCheckBoxVisible) {
        ...
        if (mRevealItHistoryListAdapter == null) {
            ...
            mRevealItHistoryListAdapter.updateListData(mHistoryListFromDatabase, isCheckBoxSelected, shouldCheckBoxVisible,mRevealItHistoryListAdapter, recycleRevealList);
