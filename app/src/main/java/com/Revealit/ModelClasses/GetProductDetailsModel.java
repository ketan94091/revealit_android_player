...
public class GetProductDetailsModel {
    ...
    public class Offers {
        ...
        private List<DataOffers> data = null;

        public List<DataOffers> getData() {
            return data;
        }

        public void setData(List<DataOffers> data) {
            this.data = data;
        }
    ...
    public class DataOffers {
        ...
        public Object getItemOffersId() {
            return item_offers_id;
        }

        public void setItemOffersId(Object item_offers_id) {
            this.item_offers_id = item_offers_id;
        }
        ...
        public void setOfferUrl(String offer_url) {
        ...
        public Object getPriceCurrency() {
            return price_currency;
        }

        public void setPriceCurrency(Object price_currency) {
            this.price_currency = price_currency;
        }

        public Object getVendorLocation() {
            return vendor_location;
        }

        public void setVendorLocation(Object vendor_location) {
            this.vendor_location = vendor_location;
        }

        public String getVendorLogoUrl() {
            return vendor_logo_url;
        }

        public void setVendorLogoUrl(String vendor_logo_url) {
