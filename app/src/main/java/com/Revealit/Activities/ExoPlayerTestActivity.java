...
public class ExoPlayerTestActivity extends AppCompatActivity implements View.OnClickListener {


    private static final String TAG = "ExoPlayerTestActivity";
    ...
    private void setIds() {
        ...
        mActivity = ExoPlayerTestActivity.this;
        mContext = ExoPlayerTestActivity.this;
...
*/
                ...
                for (int i = 0; i < data.size(); i++) {
                    ...
                    imgDynamicCoordinateView.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            Intent mIntent = new Intent(ExoPlayerTestActivity.this, ProductBuyingScreenActivity.class);
                        ...
                        imgDynamicCoordinateView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View mView) {
                                ...
                                if (CommonMethods.isDeviceSupportAR(mActivity) && mSessionManager.getPreferenceInt(Constants.TESTING_ENVIRONMENT_ID) == 2) {
                                    //OPEN AR VIEW
                                    Intent mARviewIntent = new Intent(ExoPlayerTestActivity.this, ArModelViewerWeb.class);
    ...
    private void setOverLayTouch() {
        ...
        frameOverlay.setOnTouchListener(new OnSwipeTouchListener(ExoPlayerTestActivity.this) {
            @Override
    ...
    private void displayPopupWindow(View anchorView) {
        ...
        PopupWindow popupShareSocialMedia = new PopupWindow(ExoPlayerTestActivity.this);
        ...
        txtFacebook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (CommonMethods.isAppInstalled(getApplicationContext(), "com.facebook.katana")) {
                    ...
                    ShareDialog dialog = new ShareDialog(ExoPlayerTestActivity.this);
    ...
    private void displayBlueDotsInfo(View anchorView, DotsLocationsModel.Datum blueDotMeta) {
        ...
        PopupWindow popupBlueDots = new PopupWindow(ExoPlayerTestActivity.this);
        ...
        BlueDotsMetaListAdapter mBlueDotsMetaListAdapter = new BlueDotsMetaListAdapter(mContext, ExoPlayerTestActivity.this, blueDotMeta.getBlueDotMeta(), blueDotMeta.getItemWiki().getSponsorName());
    ...
    private void openInfluencerDialoge(String itemId) {
        ...
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(ExoPlayerTestActivity.this);
    ...
    private void readWriteExternalStoragePermission() {
        ...
        if (ContextCompat.checkSelfPermission(ExoPlayerTestActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
            if (ActivityCompat.shouldShowRequestPermissionRationale(ExoPlayerTestActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE)) {
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton(getResources().getString(R.string.strOk), new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ActivityCompat.requestPermissions(ExoPlayerTestActivity.this, PERMISSIONS, REQUEST_PERMISSION);
                        }
                    })
