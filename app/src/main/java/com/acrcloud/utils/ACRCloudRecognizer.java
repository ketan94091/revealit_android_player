...
public class ACRCloudRecognizer {
    ...
    private String host = Constants.KEY_HOST_VALUE;
    private String accessKey = Constants.KEY_ACCESS_KEY_VALUE;
    private String accessSecret = Constants.KEY_ACCESS_SECRET_VALUE;
